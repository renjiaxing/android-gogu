...
public class ShowMyVoteAty extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        httpClient.get(ConstantValue.MY_SHOW_VOTE_URL, params,
...
//                            arr = new JSONArray(response);
        ...
        mListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(
                ...
                httpClient1.get(ConstantValue.UP_MY_SHOW_VOTE_URL, params,
                        new JsonHttpResponseHandler() {
            ...
            public void onPullUpToRefresh(
                ...
                httpClient2.get(ConstantValue.DOWN_MY_SHOW_VOTE_URL, params,
                        new JsonHttpResponseHandler() {
                            @Override
                            public void onSuccess(int statusCode,
                                                  Header[] headers, JSONArray response) {
